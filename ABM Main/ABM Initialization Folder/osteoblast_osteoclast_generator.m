...
%  osteoclasts are generated in the area close to the tumor. Then the
...
function [bone, BONE, MITOTIC, APOPTOTIC, pmit_cell_near_obs, papo_cell_near_obs, ...
    ...
    min_row = min(bm_rows) - 1; max_row = max(bm_rows) + 1;
    ...
    for cb_site = 1 : size(row_cortbone_edge)

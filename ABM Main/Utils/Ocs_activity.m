...
% This function is used to implement the resoprtion activity of the
        ...
        if internal_clock_ocs(row_ocs(ocs), col_ocs(ocs)) == T_ocs_resorption
            ...
            for n = 1 : 6
                ...
                if bone(j3,k3) ~= site.outer                    
                    ...
                    if bone(j3,k3) == site.cortical_bone
                        liste(1,n) = 1;
                        liste(2,n) = j3;
                        liste(3,n) = k3;
...
no_bone_marrow = (bone == site.outer | bone == site.cortical_bone | bone == site.osteoblast | bone == site.osteoclast);
